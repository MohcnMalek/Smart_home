                          ...
                          children: [
                            ...
                            if (device.type == 'light' || device.type == 'curtain') ...[
                              _LevelControl(
                                ...
                                enabled: isOn,
                                onChanged: (v) {
                                  // ✅ IMPORTANT: passer par Provider
                                  vm.setDeviceLevel(device.id, v);
                                },
                              ),
                            ],
                            ...
                            if (device.type == 'ac') ...[
                              _TempControl(
                                ...
                                enabled: isOn,
                                onTempChanged: (v) => vm.setDeviceTemp(device.id, v),
                                onModeChanged: (m) => vm.setDeviceMode(device.id, m),
                              ),
                            ],
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => const PhoneCameraPage(),
                                      ),
                                    );
                                  },
          ...
          children: [
            Expanded(
              child: Slider(
                ...
                max: 30,
                divisions: 14,
                onChanged: enabled ? onTempChanged : null,
              ),
            ),
            SizedBox(
              width: 54,
